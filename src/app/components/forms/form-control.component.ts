...
export class FormControlComponent implements AfterContentInit, OnDestroy {
  ...
  @ContentChild(AbstractFormControl, { static: true }) _formControl: AbstractFormControl<any>;
  @ContentChild(LabelDirective, { static: true, read: ElementRef }) _label: ElementRef;
