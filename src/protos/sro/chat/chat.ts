...
export const ChatService = new ServiceType("sro.chat.ChatService", [
    ...
    { name: "CreateChatChannel", options: { "google.api.http": { post: "/v1/channels", body: "*" } }, I: CreateChatChannelMessage, O: Empty },
    { name: "DeleteChatChannel", options: { "google.api.http": { delete: "/v1/channels/id/{id}" } }, I: TargetId, O: Empty },
    { name: "EditChatChannel", options: { "google.api.http": { put: "/v1/channels/id/{channel_id}", body: "*" } }, I: UpdateChatChannelRequest, O: Empty },
